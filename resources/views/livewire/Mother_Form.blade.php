        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <label for="title">{{('Passport ID Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{('Phone Mother')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{('Nationality Mather')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputState">{{('Blood Type Mather')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">{{('Religion Mather')}}</label>
