...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('my_parents', function (Blueprint $table) {
            ...
            $table->foreign('Nationality_Father_id')->references('id')
            ->on('nationalities');
            $table->bigInteger('Blood_Type_Father_id')->unsigned();
            $table->foreign('Blood_Type_Father_id')->references('id')
            ->on('type_bloods');
            $table->bigInteger('Religion_Father_id')->unsigned();
            $table->foreign('Religion_Father_id')->references('id')
            ->on('religions');
            ...
            $table->foreign('Nationality_Mother_id')->references('id')
            ->on('nationalities');
            $table->bigInteger('Blood_Type_Mother_id')->unsigned();
            $table->foreign('Blood_Type_Mother_id')->references('id')
            ->on('type_bloods');
            $table->bigInteger('Religion_Mother_id')->unsigned();
            $table->foreign('Religion_Mother_id')->references('id')
            ->on('religions');
