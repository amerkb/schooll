...
class AddParent extends Component
{
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $My_Parent->Name_Father =  $this->Name_Father_en;
            $My_Parent->National_ID_Father = $this->National_ID_Father;
            $My_Parent->Passport_ID_Father = $this->Passport_ID_Father;
            $My_Parent->Phone_Father = $this->Phone_Father;
            $My_Parent->Job_Father = $this->Job_Father_en;
            $My_Parent->Passport_ID_Father = $this->Passport_ID_Father;
            ...
            // Mother_INPUTS
            $My_Parent->Name_Mother = $this->Name_Mother_en;
            $My_Parent->National_ID_Mother = $this->National_ID_Mother;
            $My_Parent->Passport_ID_Mother = $this->Passport_ID_Mother;
            $My_Parent->Phone_Mother = $this->Phone_Mother;
            $My_Parent->Job_Mother = $this->Job_Mother_en;
            $My_Parent->Passport_ID_Mother = $this->Passport_ID_Mother;
    ...
    public function edit($id)
    {
       ...
       // $this->Name_Father = $My_Parent->getTranslation('Name_Father', 'ar');
        $this->Name_Father_en = $My_Parent->Name_Father;
       // $this->Job_Father = $My_Parent->getTranslation('Job_Father', 'ar');;
        $this->Job_Father_en = $My_Parent->Job_Father;
      ...
      //  $this->Name_Mother = $My_Parent->getTranslation('Name_Mother', 'ar');
        $this->Name_Mother_en = $My_Parent->Name_Father;
       // $this->Job_Mother = $My_Parent->getTranslation('Job_Mother', 'ar');;
        $this->Job_Mother_en = $My_Parent->Job_Mother;
    ...
    try {
        ...
        return toastr()->error('You can not delete because have attachment');
    }
}
    //clearForm
